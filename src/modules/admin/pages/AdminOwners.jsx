...
import { getAdminOwners } from '../../../services/adminService'
...
export default function AdminOwners() {
  ...
  return (
    <ModuleShell title="Super Admin" subtitle="Owners Management" navItems={navItems} accent="from-slate-900 to-slate-700">
      <SectionCard title="All Owners" subtitle="Manage property owners">
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm text-slate-600 dark:text-slate-400">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                ...
                {data.length === 0 && (
                  <tr>
                    <td colSpan="3" className="p-3 text-center text-slate-500">No owners found.</td>
                  </tr>
                )}
              </tbody>
            </table>
